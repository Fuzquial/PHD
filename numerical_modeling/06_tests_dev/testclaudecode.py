...
TOP_DISP = -0.5         # deplacement final en Step-2 (mm)
STEP2_TIME = 1200.0
...
# ============================================================
# ETAPE 1 : Construction du modele de base (geometrie, maillage,
#           materiaux, sections, assemblage, contacts, steps, BCs)
#           Sans charge de confinement (ajoutee par copie ensuite)
# ============================================================
...
# ============================================================
# ETAPE 2 : Boucle sur les pressions — copie du modele de base,
#           application de la pression specifique, soumission du job
# ============================================================
for PRESSURE_MAG in PRESSURE_LIST:
    MODEL_NAME = '%dMPa_model' % PRESSURE_MAG
    JOB_NAME   = '%dMPa_hetero' % PRESSURE_MAG

    print("--- Preparation modele %s (confinement = %d MPa) ---" % (MODEL_NAME, PRESSURE_MAG))

    # Copie du modele de base
    ...
    # Ajout de la charge de confinement specifique a cette pression
    mdl_p.Pressure(name='Load-Pressure', createStepName='Step-1',
    ...
    mdb.Job(atTime=None, contactPrint=OFF, description='', echoPrint=OFF,
            ...
            numCpus=14, numDomains=14, queue=None, scratch='', type=ANALYSIS,
            userSubroutine='', waitHours=0, waitMinutes=0)
    mdb.jobs[JOB_NAME].submit(consistencyChecking=OFF)
    print("Job soumis: %s — attente fin du calcul..." % JOB_NAME)
    mdb.jobs[JOB_NAME].waitForCompletion()
    print("Job termine: %s" % JOB_NAME)

print("Tous les jobs sont termines.")
